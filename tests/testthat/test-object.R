...
test_that("newEMSet works without controls.", {
  ...
  # Initiate test
  expect_match(class(newEMSet(assay_list)), "EMSet")
...
test_that("newEMSet works - with controls", {
  ...
  # Initiate test
  expect_match(class(newEMSet(list(counts = test_matrix), controls = controls)), "EMSet")  
})
...
test_that("newEMSet works - colInfo loading", {
  ...
  # Initiate test
  expect_match(class(newEMSet(list(counts = test_matrix), colInfo = colInfo)), "EMSet")  
})
...
test_that("newEMSet works - rowInfo loading", {
  ...
  # Initiate test
  expect_match(class(newEMSet(list(counts = test_matrix), rowInfo = rowInfo)), "EMSet")  
})
