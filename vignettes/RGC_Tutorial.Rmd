...
devtools::load_all("/Users/a.senabouth/CodeRepositories/ascend-dev")
```
...
em.set <- CellRangerToascend("RGC_scRNASeq/", "GRCh38")
```

This function loads the data into an EMSet, with the assumption that mitochondrial and ribosomal genes are controls for this experiment.
...
```{r FilterByExpressedGenesPerCell, FALSE}
