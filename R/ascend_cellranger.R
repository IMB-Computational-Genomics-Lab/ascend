# Tools for use with data generated by Cell Ranger 1.3.1 and newer
...
BuildCellRangerDataset <- function(data.dir) {
    ...
    ## Transform the data into what's required for EMSet object Extract batch labels from barcodes
...
#' LoadCellRanger
#'
#' \code{\link{LoadCellRanger}} processes data generated by Cell Ranger's
#' count pipeline into a \code{\linkS4class{EMSet}} object, for use with \pkg{ascend}.
...
#' @param genome.name This is the name of the reference genome used by Cell Ranger.
...
#' }
#' @export
LoadCellRanger <- function(cellranger.path, genome.name) {
