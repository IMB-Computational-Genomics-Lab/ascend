...
#' @return An integer
#' 
FindOptimalResult <- function(key.stats, conservative = TRUE, nres){
...
#' 
BuildKeyStat <- function(rand.matrix, nres){
  step <- 1/nres
...
#'
GenerateStabilityValues <- function(rand.idx.matrix, nres){
