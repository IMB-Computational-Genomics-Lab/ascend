...
plotDendrogram <- function(object){
  ...
  if(length(clusterAnalysis(object)) == 0){
    stop("Please cluster the data in your EMSet with runSCORE before using this function.")
  }
...
#' 
#' @param dendro Hclust object generated from \code{\link{runSCORE}}.
...
#' 
#' @param dendro hclust object generated by \code{\link{runSCORE}}.
...
plotStabilityDendro <- function(object){
  ...
  if (length(clusterAnalysis(object)) == 0){
    stop("Please run RunSCORE on this object before using this function.")
  }
...
#' EMSet:
#' 
#' 1. Distance matrix generated by \link{runSCORE}.
...
#' to review the effectiveness of clustering by the SCORE algorithm.
#'
#' @param object An \code{\linkS4class{EMSet}} object that has undergone PCA.
