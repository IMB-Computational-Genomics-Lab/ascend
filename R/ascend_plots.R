...
#' \itemize{
#' \item{\strong{Library Size}: A histogram depicting the distribution of library sizes across the dataset.}
#' \item{\strong{Average Gene Count}: A histogram depicting number of cells vs mean gene expression}
#' \item{\strong{Average Gene Count (Log2)}: A histogram depicting number of cells vs Log2 mean gene expression}
#' \item{\strong{Average Gene Count (Log10)}: A histogram depicting number of cells vs Log2 mean gene expression}
#' \item{\strong{Log 10 Average Gene Count (Smooth Scatter)}: Smooth scatter plot of number of cells vs Log10 mean gene expression}
#' \item{\strong{Top Genes Per Sample}: Violin/beehive plots depicting proportion of top genes per sample}
#' \item{\strong{Top Gene Expression}: Boxplots depicting top 50 genes in terms of expression}
#' }

#' If controls are defined, two additional plots are generated:
#' \itemize{
#' \item{\strong{Percentage Control Expression}: Histograms depicting number of cells with the contribution of control genes as a percentage of total counts}
