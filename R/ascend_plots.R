...
#' Please use the \code{\link[ascend:calculateCV-EMSet-method]{calculateCV}} 
...
plotVolcano <- function(x, threshold = 5e-3,
  ...
  volcano_plot <- ggplot2::ggplot(x, ggplot2::aes(log2FoldChange, padj)) + 
    ...
    ggplot2::scale_colour_manual(name = "", values = c("Not significant" = "#474747", "Significant" = "#ff5000")) + 
...
#' PlotConsensusBars
#' 
#' Adapted from plotColorUnderTree found in the \pkg{WGCNA} package.
#' 
...
#' PlotOrderedColors
#' 
#' Adapted from plotOrderedColors found in the \pkg{WGCNA} package.
...
#' EMSet:
#' 
#' 1. Distance matrix generated by \code{\link[ascend:runCORE-EMSet-method]{runCORE}}.
#' 2. PCA matrix generated by \code{\link[ascend:runPCA-EMSet-method]{runPCA}}.
...
#' 
#' # Generate MDS
#' mds_plot <- plotMDS(EMSet, Dim1 = 1, Dim2 = 2, group = "cluster")
#' 
#' }
...
#' \code{\link[ascend:runTSNE-EMSet-method]{runTSNE}} function.
#' 
...
#' 
#' # Plot with t-SNE 
#' tsne_plot <- plotTSNE(EMSet, Dim1 = 1, Dim2 = 2, group = "cluster")
#' 
#' }
#' @importFrom ggplot2 ggplot aes geom_point labs ggtitle scale_alpha theme_bw
#' @export
...
#' 
#' # Generate MDS
#' pca_plot <- plotPCA(EMSet, PCX = 1, PCY = 2, group = "cluster")
#' 
#' }
#' @importFrom ggplot2 ggplot aes geom_point labs ggtitle scale_alpha theme_bw
...
#' \code{\link[ascend:runPCA-EMSet-method]{runPCA}}. 
...
#' 
#' # PCA Variance
#' pca_variance_plot <- plotPCAVariance(EMSet, n = 100)
#' 
#' }
...
#' @examples 
#' \dontrun{
#' control_histogram <- plotControlHist(EMSet, control = "Mt")
#' }
#' @export
...
#' @examples 
#' \dontrun{
#' feature_plot <- plotFeatureHist(EMSet)
#' }
#' @export
#' @importFrom dplyr left_join
...
#' @examples
#' \dontrun{
#' top_genes_violin <- plotTopGenesPerSample(EMSet)
#' }
#' @export
#' @importFrom dplyr left_join
