...
setClass("AEMSet", representation(ExpressionMatrix = "Matrix", GeneAnnotation = "data.frame",
                                  BatchInformation = "list", Controls = "list", PCA = "list", Conditions = "list",
                                  Clusters = "list", DifferentialExpression = "list", Metrics = "list",
                                  Log = "list"), prototype(ExpressionMatrix = Matrix::Matrix(0, nrow = 0, ncol = 0, sparse = TRUE),
                                                           GeneAnnotation = data.frame(matrix(nr = 0, nc = 0)),
                                                           BatchInformation = list(), Controls = list(),
                                                           Conditions = list(), PCA = list(),
...
#'
GenerateControlMetrics <- function(x, expression.matrix, control.list,
                                   total.counts) {
...
setMethod("GenerateMetrics", signature("AEMSet"), function(object) {
  ...
  # Generate Metrics
  control.counts <- lapply(names(control.list), function(x) GenerateControlMetrics(x, expression.matrix, control.list, total.counts))
