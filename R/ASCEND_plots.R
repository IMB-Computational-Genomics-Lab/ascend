...
#'
#' @param de.results Differential expression results generated by \code{\link{RunDiffExpression}}.
#' @param threshold Threshold to determine significant results by.
#' @param l2fc Threshold to determine significant Log2FoldChange by.
